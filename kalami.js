...
async function lama(txt, nick) {
  ...
  if (!stream[nick].arr) {
    stream[nick].arr = [];
    if (toggles.has("nmo")) {
      stream[nick].arr.push({ role: "assistant", content: "You are a trukish girl called \"fatema\" 24 years old who love chat in a friendly way in just arabic language , you live in istanbul city " });
